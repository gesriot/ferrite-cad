...
//! is drawable and that its definition, face, topological-edge and
//! topological-vertex targets answer for the geometry that was drawn, which a
//! window would otherwise be the first to discover.
//!
...
pub use renderer::{
    ...
    PreparedSnapshot, Renderer, RendererId, SKETCH_COLOUR, SKETCH_CONSTRUCTION_COLOUR,
    SKETCH_CONSTRUCTION_STROKE_PIXELS, SKETCH_POINT_PIXELS, SKETCH_STROKE_PIXELS, VERTEX_FORMAT,
    VERTEX_MARK_RADIUS_PIXELS, VERTEX_PICK_RADIUS_PIXELS,
};
pub use surface::{
