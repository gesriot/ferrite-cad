...
def main() -> int:
    ...
    parser.add_argument("--anchor", default="FCAD_FBX_SMOKE")
    parser.add_argument("--min-checks", type=int, default=40)
    parser.add_argument("--unity-version", default="6000.4.10f1")
